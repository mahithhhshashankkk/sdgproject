...
const DEMO_USERS: Record<Role, DbUser> = {
  farmer: { id: 'a0000000-0000-0000-0000-000000000002', role: 'farmer', phone: '+919000000002', language: 'kn', region: 'Kolar', name: 'Ravi Kumar', created_at: '' },
  technician: { id: 'a0000000-0000-0000-0000-000000000004', role: 'technician', phone: '+919000000004', language: 'kn', region: 'Kolar', name: 'Manjunath', created_at: '' },
